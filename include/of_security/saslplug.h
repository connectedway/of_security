...
typedef struct sasl_utils {
    ...
    void (*MD5Update)(MD5_CTX *, const unsigned char *text, OFC_SIZET len);
...
typedef struct sasl_out_params {
    ...
    void *encode_context;
    int (*encode)(void *context, const OFC_IOVEC *invec, unsigned numiov,
...
#define SASL_CB_PRESENT(params)     ((params)->cbinding != OFC_NULL)
 ...
 */
LIBSASL_API int of_security_client_add_plugin
(const char *plugname,
...
LIBSASL_API int 
of_security_client_plugin_info (const char *mech_list,
 ...
 */
LIBSASL_API int of_security_server_add_plugin(const char *plugname,
...
LIBSASL_API int of_security_server_plugin_info (const char *mech_list,
 ...
 */
LIBSASL_API int 
of_security_canonuser_add_plugin(const char *plugname,
 ...
 */
LIBSASL_API int of_security_auxprop_add_plugin(const char *plugname,
...
LIBSASL_API int of_security_auxprop_plugin_info (const char *mech_list,
